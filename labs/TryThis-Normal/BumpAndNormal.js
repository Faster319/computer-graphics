...
function main() {
    ...
    //change code here >> adding normal map
    ...
    var cubeNorm = new THREE.Mesh(cubeGeo, cubeMaterial);
    cubeNorm.position.x = cubeSize;
    cubeNorm.position.y = cubeSize / 2;
    cubeNorm.rotation.y = 1 / 3 * Math.PI;
    scene.add(cubeNorm);
    ///
